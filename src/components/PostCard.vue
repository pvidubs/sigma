  ...
  <div class="flex flex-col overflow-hidden rounded-2xl w-72 xl:w-80 h-96">
    ...
    <div class="relative grow">
      <div class="absolute bottom-0">
        ...
        <div class="w-28 h-48 flex flex-col text-white px-3 py-5 text-center" :class="bgColor">
          <div class="flex-grow flex flex-col items-center font-poppins font-extrabold mt-8">
      ...
      <div class="w-44 xl:w-52 h-full absolute right-0 px-3 pt-2 pb-4 flex flex-col">
        ...
        <div class="font-bahnschrift font-semibold grid grid-cols-4 grid-rows-2 grow gap-y-2">
          <div
            v-for="(value, index) in details"
            :key="index"
            class="h-5 flex place-self-center scoped-gap"
          >
            <div class="w-5 h-5 rounded-md" :class="value > 0 ? bgColor : 'bg-gray-100'"></div>
            <span
